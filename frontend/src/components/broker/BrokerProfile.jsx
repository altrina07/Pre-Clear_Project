  ...
  return (
    <div style={{ background: WHITE, minHeight: '100vh', padding: 24 }}>
      <div style={{ maxWidth: 1024, margin: '0 auto', color: DARK }}>
        <h1 style={{ color: DARK, marginBottom: 8 }}>Broker Profile</h1>
        <p style={{ color: SOFT, marginBottom: 24 }}>
        ...
        <div style={{ display: 'grid', gap: 24 }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 18, marginBottom: 12 }}>
              <div style={{ position: 'relative' }}>
                ...
                >
                  <Upload style={{ width: 16, height: 16, color: DARK }} />
                </button>
              </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
              ...
              <h3 style={{ color: DARK, margin: 0 }}>Company / Organization</h3>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div>
                <label style={{ display: 'block', color: SOFT, marginBottom: 8, fontSize: 13 }}>License Number</label>
                <input
                  type="text"
                  name="licenseNumber"
              ...
              <div>
                <label style={{ display: 'block', color: SOFT, marginBottom: 8, fontSize: 13 }}>Years of Experience</label>
                <select
          ...
          <div
            className="rounded-xl p-6"
            style={{
              background: '#FFF3CC', // slightly warm yellow card for status
              borderRadius: 12,
              border: `1px solid ${MUTED_BORDER}`,
            }}
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
              <Shield style={{ width: 18, height: 18, color: DARK }} />
              <h3 style={{ color: DARK, margin: 0 }}>Broker Status</h3>
            </div>

            <p style={{ color: SOFT, marginBottom: 12, fontSize: 13 }}>
              Your broker account is active and verified
            </p>

            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              <div style={{ background: WHITE, borderRadius: 8, padding: 12 }}>
                <p style={{ color: SOFT, fontSize: 12, margin: 0 }}>Licensed Since</p>
                <p style={{ color: DARK, margin: '6px 0 0 0', fontWeight: 600 }}>June 2014</p>
              </div>

              <div style={{ background: WHITE, borderRadius: 8, padding: 12 }}>
                <p style={{ color: SOFT, fontSize: 12, margin: 0 }}>Total Reviews</p>
                <p style={{ color: DARK, margin: '6px 0 0 0', fontWeight: 600 }}>247 Shipments</p>
              </div>
            </div>
          </div>
        </div>
